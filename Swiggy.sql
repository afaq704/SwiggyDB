...
#Q8 FIND THE RESTAURANTS THAT HAVE AN AVERAGE COST WHICH IS HIGHER THAN THE TOTAL AVERAGE COST 
-- OF ALL RESTAURANTS TOGETHER.
...
select restaurant_name, menu_category, count(item) as Number_Of_Items
from swiggy
